...
const tripPointsPresenter = new _presenters_trip__WEBPACK_IMPORTED_MODULE_6__["default"](pageBodyContainer);
...
class PointPresenter {
  ...
  _renderPoint() {
    ...
    this._pointComponent = new _view_point__WEBPACK_IMPORTED_MODULE_1__["default"](this._point);
    this._pointEditComponent = new _view_edit_point__WEBPACK_IMPORTED_MODULE_2__["default"](this._point);
...
class TripPresenter {
  constructor(container) {
    this._container = container;
    this._taskPresenter = {};
    this._currentSortType = _constants_js__WEBPACK_IMPORTED_MODULE_8__["SortType"].DAY;
  ...
  _renderPoint(point) {
    const pointPresenter = new _point__WEBPACK_IMPORTED_MODULE_5__["default"](this._listComponent, this._onPointUpdate, this._onModeUpdate);
  ...
  _onPointUpdate(updatedPoint) {
    this._points = Object(_utils_common__WEBPACK_IMPORTED_MODULE_6__["updateItem"])(this._points, updatedPoint);
...
/*!****************************!*\
  !*** ./src/utils/point.js ***!
  \****************************/
/*! exports provided: SortTypes, sortPointsByDay, sortPointsByTime, sortPointsByPrice */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!****************************!*\
  !*** ./src/utils/utils.js ***!
  \****************************/
/*! exports provided: isEscape, isMainClick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _event_type_items__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./event-type-items */ "./src/view/event-type-items.js");
/* harmony import */ var _cities_datalist__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./cities-datalist */ "./src/view/cities-datalist.js");
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./abstract */ "./src/view/abstract.js");
...
const createEditPointTemplate = (point) => {
  ...
  const availableOffers = Object(_mock_option__WEBPACK_IMPORTED_MODULE_1__["getOffersByPointType"])(pointType);
      ...
      <form class="event event--edit" action="#" method="post">
        <header class="event__header">
          <div class="event__type-wrapper">
            ...
            <div class="event__type-list">
              <fieldset class="event__type-group">
                ...
                ${new _event_type_items__WEBPACK_IMPORTED_MODULE_5__["default"](pointType).getTemplate()}
              </fieldset>
            </div>
          </div>
          ...
          <div class="event__field-group  event__field-group--destination">
            ...
            ${new _cities_datalist__WEBPACK_IMPORTED_MODULE_6__["default"]().getTemplate()}
          </div>
        ...
        ${availableOffers.length || destinationDescription ? `
          <section class="event__details">
            ${availableOffers.length ? new _available_offers__WEBPACK_IMPORTED_MODULE_3__["default"](availableOffers, offers).getTemplate() : ``}
...
class EditPoint extends _abstract__WEBPACK_IMPORTED_MODULE_7__["default"] {
  constructor(point) {
    super();
    this._point = point;
  ...
  _clickHandler(event) {
    if (Object(_utils_utils__WEBPACK_IMPORTED_MODULE_8__["isMainClick"])(event)) {
      event.preventDefault();
...
class Point extends _abstract__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(point) {
    super();
    this._point = point;
  ...
  _onClickHandler(event) {
    if (Object(_utils_utils__WEBPACK_IMPORTED_MODULE_3__["isMainClick"])(event)) {
      event.preventDefault();
      this._callback.click();
    }
  }
    ...
    <form class="trip-events__trip-sort  trip-sort" action="#" method="get">
      <div class="trip-sort__item trip-sort__item--day">
        <input
          ...
          name="trip-sort"
          value="sort-day"
          data-sort-type="${_utils_point__WEBPACK_IMPORTED_MODULE_1__["SortTypes"].DAY}"
        >
      ...
      <div class="trip-sort__item  trip-sort__item--time">
        <input
          ...
          name="trip-sort"
          value="sort-time"
          data-sort-type="${_utils_point__WEBPACK_IMPORTED_MODULE_1__["SortTypes"].TIME}"
        >
      ...
      <div class="trip-sort__item  trip-sort__item--price">
        <input
          ...
          name="trip-sort"
          value="sort-price"
          data-sort-type="${_utils_point__WEBPACK_IMPORTED_MODULE_1__["SortTypes"].PRICE}"
          checked
        >
